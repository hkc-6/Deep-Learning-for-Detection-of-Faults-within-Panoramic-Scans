### Run ResNet50 V2 on Cats and Dogs images
...
ResRD = kt.RandomSearch(
            partial(TuneNetwork,inputNet = tf.keras.applications.ResNet50V2),
...
RandomHistory = TestNetwork(inputNet = tf.keras.applications.ResNet50V2,
                            **Best_Random_HP,
                            tuner_epochs = 0,
...
bestEpoch = 2
RandomModel = TestNetwork(inputNet = tf.keras.applications.ResNet50V2,
                          **Best_Random_HP,
                          tuner_epochs = 0,
                          tuner_initial_epoch = 0,
                          tuner_bracket = 0,
