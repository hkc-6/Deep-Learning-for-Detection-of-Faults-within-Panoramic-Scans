### Run InceptionResNet V2 on filtered images cropped by object detection
...
inputModel = '~\\ModelsCropped\\InceptionResNetV2_RandomFinal_Model.h5'
inputParam = '~\\ModelsCropped\\InceptionResNetV2_RandomFinal_Model.txt'
